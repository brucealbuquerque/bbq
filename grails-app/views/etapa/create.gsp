...
<html>
	...
	<body>
		<a href="#create-etapa" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-etapa" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:etapaInstance, action:'save']" >
				<fieldset class="form">
