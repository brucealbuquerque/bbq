...
<html>
	...
	<body>
		<a href="#create-receita" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-receita" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:receitaInstance, action:'save']" >
				<fieldset class="form">
