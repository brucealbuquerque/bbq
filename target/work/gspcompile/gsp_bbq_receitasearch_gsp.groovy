...
class gsp_bbq_receitasearch_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/receita/search.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(22)
invokeTag('createLink','g',65,['controller':("Receita"),'action':("image"),'width':("320"),'height':("240"),'params':([id: receita.id])],-1)
printHtmlPart(23)
expressionOut.print(receita.id)
printHtmlPart(24)
...
public static final long LAST_MODIFIED = 1440970370000L
